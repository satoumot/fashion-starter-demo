...
export const updateCustomerFormSchema = z.object({
  first_name: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
  last_name: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
...
export const customerAddressSchema = z.object({
  ...
  address_1: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
  address_2: z.string().optional().nullable(),
  city: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
  postal_code: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
...
export const signupFormSchema = z.object({
  email: z.string({ message: '入力してください'}).email('メールアドレスを入力してください'),
  first_name: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
  last_name: z.string({ message: '入力してください'}).min(1, { message: '入力してください'}),
  phone: z.string().optional().nullable(),
  password: z.string({ message: '入力してください'}).min(6, { message: '最低6文字です'}),
})
