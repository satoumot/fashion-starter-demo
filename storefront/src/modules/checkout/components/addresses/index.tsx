...
const addressesFormSchema = z
  .object({
    shipping_address: z.object({
      ...
      last_name: z.string().min(1, { message: '氏を入力してください'}),
      company: z.string().optional(),
      address_1: z.string().min(1, { message: '都道府県を入力してください'}),
      address_2: z.string().optional(),
      city: z.string().min(1, { message: '市区町村・丁目番地を入力してください'}),
      postal_code: z.string().min(1, { message: '郵便番号を入力してください'}),
      province: z.string().optional(),
      country_code: z.string().min(2, { message: '国を選択してください'}),
      ...
      {isOpen ? (
        ...
        <div className="flex flex-col gap-4">
          <div className="flex max-sm:flex-col flex-wrap gap-y-2 gap-x-12">
            <div className="text-grayscale-500">配送先住所</div>
          ...
          {sameAsBilling || cart.billing_address ? (
            <div className="flex max-sm:flex-col flex-wrap gap-y-2 gap-x-17">
              <div className="text-grayscale-500">請求先住所</div>
              <div className="text-grayscale-600">
                {sameAsBilling ? (
                  "上記の住所と同じ"
                ) : (
