    ...
    <div className={className}>
      ...
      >
        <div className="flex justify-between">
          <p className="text-grayscale-500">小計：</p>
          <p
            className="self-end"
        ...
        {!!discount_total && (
          <div className="flex justify-between">
            <p className="text-grayscale-500">割引：</p>
            <p
              className="self-end"
        ...
        <div className="flex justify-between">
          <p className="text-grayscale-500">送料：</p>
          <p
            className="self-end"
        ...
        <div className="flex justify-between">
          <p className="text-grayscale-500">税：</p>
          <p
            className="self-end"
        ...
        {!!gift_card_total && (
          <div className="flex justify-between">
            <p className="text-grayscale-500">ギフトカード：</p>
            <p
              className="self-end"
