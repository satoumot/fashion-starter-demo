        ...
        <div className="flex flex-col gap-8 flex-1">
          <div className="flex flex-wrap justify-between gap-6">
            <div className="sm:grow sm:basis-0">
              <p className="text-xs text-grayscale-500 mb-1.5">郵便番号</p>
              <p>{address.postal_code}</p>
            </div>
            <div className="sm:grow sm:basis-0">
              <p className="text-xs text-grayscale-500 mb-1.5">都道府県</p>
          ...
          <div className="flex flex-wrap justify-between gap-6">
            ...
            <div className="sm:grow sm:basis-0">
              {/* <p className="text-xs text-grayscale-500 mb-1.5">国</p>
              <p>
                {countries.find(
                  (country) => country.iso_2 === address.country_code
                )?.display_name || address.country_code}
              </p> */}
              <p className="text-xs text-grayscale-500 mb-1.5">市区町村・丁目番地</p>
              <p>{address.city}</p>
            </div>
