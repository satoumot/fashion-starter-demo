          ...
          <LayoutColumn>
            <div className="flex justify-between items-center h-18 md:h-21">
              <h1 className="font-medium text-md">
                <LocalizedLink href="/">Systena.</LocalizedLink>
              </h1>
              <div className="flex items-center gap-8 max-md:hidden">
                {/* <LocalizedLink href="/about">サイト概要</LocalizedLink> */}
                <LocalizedLink href="/inspiration">特集</LocalizedLink>
                <LocalizedLink href="/store">商品一覧</LocalizedLink>
              </div>
